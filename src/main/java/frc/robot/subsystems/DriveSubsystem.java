...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final WPI_VictorSPX  m_leftMotor1 = new WPI_VictorSPX (4);
  private final WPI_VictorSPX  m_leftMotor2 = new WPI_VictorSPX (3);

  private final WPI_VictorSPX  m_rightMotor1 = new WPI_VictorSPX (1);
  private final WPI_VictorSPX  m_rightMotor2 = new WPI_VictorSPX (2);
